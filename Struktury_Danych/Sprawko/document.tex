...
32 B. Na jeden element składa się pole wartości przechowujące liczbę naturalną, wskaźnik na lewego syna elementu i wskaźnik na prawego syna elementu.
	...
	\subsection*{Wykresy przedstawiające średni czas tworzenia struktury, w milisekundach, od liczby elementów}
%Wykreshy
\begin{figure}[H]
...
\subsection*{Wykresy przedstawiające średnie czasy wyszukiwania wszystkich elementów struktury, w milisekundach, liczby elementów}
...
%%WYKRES WYSOKOSCI DRZEW
	\begin{figure}[H]
		\subsection*{Wykres przedstawiający wysokości drzew od liczby elementów}
		\centering
		\begin{tikzpicture}
		\begin{axis}[
		width=0.9\textwidth,
